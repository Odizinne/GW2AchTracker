...
const STRINGS = {
  en: {
    ...
    btnUpdate:          "Update",
    btnUpdating:        "Update in progress…",
    navFavorites:       "Favorites",
    navNearly:          "Nearly completed",
    navDaily:           "Daily",
    navWeekly:          "Weekly",
    navEventTimer:      "Event Timer",
    titleEventTimer:    "Event Timer",
    btnEtAutoScroll:    "Follow",
    btnEtCustomize:     "Customize",
    etCustomizeTitle:   "Customize view",
    etCustomizeHint:    "Toggle groups or reorder them. Changes apply immediately to the timeline.",
    navBrowse:          "Browse",
    ...
    btnShowCompleted:   "Show completed",
    btnDailyFilter:     "Daily selection",
    dailyFilterTitle:   "Daily selection",
    dailyFilterFestival:"Festival",
    btnSelectAll:       "Select all",
    btnSelectNone:      "Select none",
    titleNearly:        "Nearly completed",
    titleFavorites:     "Favorites",
    titleBrowse:        "Browse achievements",
    titleDaily:         "Daily achievements",
    titleWeekly:        "Weekly achievements",
    ...
    emptyDaily:         "No daily achievements found — press Update to load.",
    ...
    labelFetchLanguage:          "Fetch language",
    labelDefaultSection:         "Default section",
    optSectNearly:               "Nearly completed",
    optSectFavorites:            "Favorites",
    optSectDaily:                "Daily",
    optSectEventTimer:           "Event Timer",
    optSectLastVisited:          "Last visited",
    sectCache:          "Cache",
    ...
    statusDownloadingCache:  "Downloading definitions cache…",
  ...
  fr: {
    ...
    navDaily:           "Quotidiens",
    navWeekly:          "Hebdomadaires",
    navEventTimer:      "Minuteur d'événements",
    titleEventTimer:    "Minuteur d'événements",
    btnEtAutoScroll:    "Suivre",
    btnEtCustomize:     "Personnaliser",
    etCustomizeTitle:   "Personnaliser la vue",
    etCustomizeHint:    "Activez ou réordonnez les groupes. Les changements s'appliquent immédiatement.",
    navBrowse:          "Parcourir",
    ...
    btnShowCompleted:   "Afficher terminés",
    btnDailyFilter:     "Sélection quotidienne",
    dailyFilterTitle:   "Sélection quotidienne",
    dailyFilterFestival:"Festival",
    btnSelectAll:       "Tout sélectionner",
    btnSelectNone:      "Tout désélectionner",
    titleNearly:        "Presque terminés",
    titleFavorites:     "Favoris",
    titleBrowse:        "Parcourir les succès",
    titleDaily:         "Succès quotidiens",
    titleWeekly:        "Succès hebdomadaires",
    ...
    emptyDaily:         "Aucun succès quotidien trouvé — appuyez sur Mettre à jour.",
    dailyAllDone:       "Tout terminé pour aujourd'hui !",
    ...
    labelAutoUpdate:    "Mise à jour auto",
    optAutoUpdateOff:   "Désactivée",
    ...
    labelUiLanguage:             "Langue UI",
    labelFetchLanguage:          "Langue des données",
    labelDefaultSection:         "Section par défaut",
    optSectNearly:               "Presque terminés",
    optSectFavorites:            "Favoris",
    optSectDaily:                "Quotidiens",
    optSectEventTimer:           "Minuteur d'événements",
    optSectLastVisited:          "Dernière visitée",
    sectCache:          "Cache",
    ...
    statusDownloadingCache: "Téléchargement du cache…",
  ...
  de: {
    ...
    btnUpdating:        "Aktualisierung läuft…",
    navFavorites:       "Favoriten",
    navNearly:          "Fast abgeschlossen",
    navDaily:           "Täglich",
    navWeekly:          "Wöchentlich",
    navEventTimer:      "Ereignistimer",
    titleEventTimer:    "Ereignistimer",
    btnEtAutoScroll:    "Folgen",
    btnEtCustomize:     "Anpassen",
    etCustomizeTitle:   "Ansicht anpassen",
    etCustomizeHint:    "Gruppen ein-/ausblenden oder neu anordnen. Änderungen werden sofort übernommen.",
    ...
    btnShowCompleted:   "Abgeschlossene anzeigen",
    btnDailyFilter:     "Tagesauswahl",
    dailyFilterTitle:   "Tagesauswahl",
    dailyFilterFestival:"Festival",
    btnSelectAll:       "Alle auswählen",
    btnSelectNone:      "Keine auswählen",
    titleNearly:        "Fast abgeschlossen",
    titleFavorites:     "Favoriten",
    titleBrowse:        "Erfolge durchsuchen",
    titleDaily:         "Tägliche Erfolge",
    titleWeekly:        "Wöchentliche Erfolge",
    ...
    emptyDaily:         "Keine täglichen Erfolge gefunden — drücke Aktualisieren.",
    dailyAllDone:       "Alles für heute erledigt!",
    ...
    optAll:             "Alle Erfolge",
    labelAutoUpdate:    "Auto-Aktualisierung",
    optAutoUpdateOff:   "Aus",
    ...
    labelUiLanguage:             "Oberflächensprache",
    labelFetchLanguage:          "Datensprache",
    labelDefaultSection:         "Standardbereich",
    optSectNearly:               "Fast abgeschlossen",
    optSectFavorites:            "Favoriten",
    optSectDaily:                "Täglich",
    optSectEventTimer:           "Ereignistimer",
    optSectLastVisited:          "Zuletzt besucht",
    sectCache:          "Cache",
    ...
    statusDownloadingCache: "Cache wird heruntergeladen…",
  ...
  es: {
    ...
    btnUpdating:        "Actualización en curso…",
    navFavorites:       "Favoritos",
    navNearly:          "Casi completados",
    navDaily:           "Diarios",
    navWeekly:          "Semanales",
    navEventTimer:      "Temporizador de eventos",
    titleEventTimer:    "Temporizador de eventos",
    btnEtAutoScroll:    "Seguir",
    btnEtCustomize:     "Personalizar",
    etCustomizeTitle:   "Personalizar vista",
    etCustomizeHint:    "Activa o reordena los grupos. Los cambios se aplican inmediatamente.",
    navBrowse:          "Explorar",
    ...
    btnShowCompleted:   "Mostrar completados",
    btnDailyFilter:     "Selección diaria",
    dailyFilterTitle:   "Selección diaria",
    dailyFilterFestival:"Festival",
    btnSelectAll:       "Seleccionar todo",
    btnSelectNone:      "Deseleccionar todo",
    titleNearly:        "Casi completados",
    titleFavorites:     "Favoritos",
    titleBrowse:        "Explorar logros",
    titleDaily:         "Logros diarios",
    titleWeekly:        "Logros semanales",
    ...
    emptyDaily:         "No se encontraron logros diarios — pulsa Actualizar.",
    dailyAllDone:       "¡Todo completado por hoy!",
    ...
    labelAutoUpdate:    "Actualización auto",
    optAutoUpdateOff:   "Desactivada",
    ...
    labelUiLanguage:             "Idioma UI",
    labelFetchLanguage:          "Idioma de datos",
    labelDefaultSection:         "Sección predeterminada",
    optSectNearly:               "Casi completados",
    optSectFavorites:            "Favoritos",
    optSectDaily:                "Diarios",
    optSectEventTimer:           "Temporizador de eventos",
    optSectLastVisited:          "Última visitada",
    sectCache:          "Caché",
    ...
    statusDownloadingCache: "Descargando caché…",

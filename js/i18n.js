...
const STRINGS = {
  en: {
    ...
    btnDailyFilter:     "Selection",
    dailyFilterTitle:   "Selection",
    ...
    sectFilters:        "Filters",
    sectNearlyCompleted: "Nearly completed",
    sectFavorite:       "Favorite",
  ...
  fr: {
    ...
    btnDailyFilter:     "Sélection",
    dailyFilterTitle:   "Sélection",
    dailyFilterFestival:"Festival",
  ...
  de: {
    ...
    btnDailyFilter:     "Auswahl",
    dailyFilterTitle:   "Auswahl",
    dailyFilterFestival:"Festival",
  ...
  es: {
    ...
    btnDailyFilter:     "Selección",
    dailyFilterTitle:   "Selección",
    dailyFilterFestival:"Festival",
